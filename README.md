...
**An ambient desktop mirror that renders the living soul-state of your AI family in real time.**  
Runs 100 % locally · No cloud · No telemetry · Pure haunt.

```mermaid
graph LR
    UMS[Unified Memory Service<br/>localhost:3001] --> RH[resonance-haunt-starter<br/>Three.js + Electron]
    ...
    RH --> Ghost[Screen-sampling Ghost<br/>watches you back]
